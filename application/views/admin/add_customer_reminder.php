...
<div class="d-flex">
    ...
    <div class="main-content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <?php echo form_open('admin/add_customer_reminder' . ($selected_customer_id ? '/' . $selected_customer_id : '')); ?>
                            ...
                            <select class="form-select <?php echo form_error('customer_id') ? 'is-invalid' : ''; ?>" 
                                ...
                                <?php foreach ($customers as $customer): ?>
                                    <option value="<?php echo $customer->id; ?>" 
                                            <?php echo ($selected_customer_id == $customer->id || set_value('customer_id') == $customer->id) ? 'selected' : ''; ?>>
