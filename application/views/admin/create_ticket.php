        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url('admin/tickets'); ?>">Support Tickets</a></li>
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
                <div class="btn-group me-2">
                    <a href="<?php echo base_url('admin/tickets'); ?>" class="btn btn-outline-secondary btn-sm">
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php echo form_open('admin/create_ticket'); ?>
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="<?php echo $redirect_url ? $redirect_url : base_url('admin/tickets'); ?>" class="btn btn-outline-secondary">
