        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
                <div class="btn-group me-2">
                    <a href="<?php echo base_url('admin/add_user'); ?>" class="btn btn-primary btn-sm">
                        <i class="fas fa-user-plus me-1"></i>Add User
                    </a>
                    <a href="<?php echo base_url('admin/create_order'); ?>" class="btn btn-success btn-sm">
                        <i class="fas fa-plus me-1"></i>Create Order
                    </a>
                    <a href="<?php echo base_url('admin/add_lead'); ?>" class="btn btn-warning btn-sm">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card stats-card products h-100">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col">
                                <div class="stats-number text-info"><?php echo $total_products; ?></div>
                                <div class="stats-label">Products</div>
                            </div>
                            <div class="col-auto">
                                <i class="fas fa-pills fa-2x text-info opacity-50"></i>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6 mb-4">
                <div class="card h-100">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo base_url('admin/orders'); ?>" class="btn btn-sm btn-outline-primary">View All</a>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="<?php echo base_url('admin/view_order/' . $order->id); ?>" class="text-decoration-none">
                                                    <?php echo htmlspecialchars($order->order_number); ?>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="<?php echo base_url('admin/view_customer/' . $order->user_id); ?>" class="text-decoration-none">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="<?php echo base_url('admin/view_customer/' . $customer->id); ?>" class="text-decoration-none">
            ...
            <div class="col-lg-6 mb-4">
                <div class="card h-100">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo base_url('admin/leads'); ?>" class="btn btn-sm btn-outline-warning">View All</a>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="<?php echo base_url('admin/view_lead/' . $lead->id); ?>" class="text-decoration-none">
            ...
            <div class="col-lg-6 mb-4">
                <div class="card h-100">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo base_url('admin/tickets'); ?>" class="btn btn-sm btn-outline-danger">View All</a>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="<?php echo base_url('admin/view_ticket/' . $ticket->id); ?>" class="text-decoration-none">
                                                    <?php echo htmlspecialchars($ticket->ticket_number); ?>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="<?php echo base_url('admin/view_customer/' . $ticket->user_id); ?>" class="text-decoration-none">
            ...
            <div class="col-12 mb-4">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo base_url('admin/customer_reminders'); ?>" class="btn btn-sm btn-outline-indigo">View All</a>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="<?php echo base_url('admin/view_customer/' . $reminder->customer_id); ?>" class="text-decoration-none">
                        ...
                        <?php else: ?>
                            <div class="text-center py-4">
                                ...
                                <a href="<?php echo base_url('admin/add_customer_reminder'); ?>" class="btn btn-indigo btn-sm">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                <a href="<?php echo base_url('admin/add_user'); ?>" class="btn btn-outline-primary w-100">
                                    <i class="fas fa-user-plus me-2"></i>Add New User
                                </a>
                            </div>
                            <div class="col-md-3 mb-3">
                                <a href="<?php echo base_url('admin/add_product'); ?>" class="btn btn-outline-success w-100">
                                    <i class="fas fa-plus me-2"></i>Add New Product
                                </a>
                            </div>
                            <div class="col-md-3 mb-3">
                                <a href="<?php echo base_url('admin/create_order'); ?>" class="btn btn-outline-warning w-100">
                                    <i class="fas fa-shopping-cart me-2"></i>Create Order
                                </a>
                            </div>
                            <div class="col-md-3 mb-3">
                                <a href="<?php echo base_url('admin/add_lead'); ?>" class="btn btn-outline-info w-100">
                                    <i class="fas fa-user-plus me-2"></i>Add New Lead
                                </a>
                            </div>
                            <div class="col-md-3 mb-3">
                                <a href="<?php echo base_url('admin/add_payment_method'); ?>" class="btn btn-outline-secondary w-100">
                                    <i class="fas fa-credit-card me-2"></i>Add Payment Method
                                </a>
                            </div>
                            <div class="col-md-3 mb-3">
                                <a href="<?php echo base_url('admin/leads'); ?>" class="btn btn-outline-warning w-100">
                                    <i class="fas fa-users me-2"></i>Manage Leads
                                </a>
                            </div>
                            <div class="col-md-3 mb-3">
                                <a href="<?php echo base_url('admin/tickets'); ?>" class="btn btn-outline-danger w-100">
                                    <i class="fas fa-headset me-2"></i>Support Tickets
                                </a>
                            </div>
                            <div class="col-md-3 mb-3">
                                <a href="<?php echo base_url('admin/recharge_requests'); ?>" class="btn btn-outline-orange w-100">
                                    <i class="fas fa-credit-card me-2"></i>Recharge Requests
                                </a>
                            </div>
                            <div class="col-md-3 mb-3">
                                <a href="<?php echo base_url('admin/customer_reminders'); ?>" class="btn btn-outline-indigo w-100">
