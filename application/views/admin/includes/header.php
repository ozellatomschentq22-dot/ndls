...
<head>
    ...
    <title><?php echo isset($title) ? $title : 'Admin Panel'; ?> - USA Pharmacy 365 Admin</title>
                    ...
                    <li class="nav-item dropdown me-3">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end notification-dropdown" style="width: 350px; max-height: 400px; overflow-y: auto;">
                            ...
                            <li class="dropdown-item text-center">
                                <a href="<?php echo base_url('admin/notifications'); ?>" class="text-decoration-none">
                    ...
                    <li class="nav-item dropdown me-3">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end reminder-dropdown" style="width: 350px; max-height: 400px; overflow-y: auto;">
                            <li class="dropdown-header d-flex justify-content-between align-items-center">
                                ...
                                <a href="<?php echo base_url('admin/customer_reminders'); ?>" class="btn btn-sm btn-outline-primary">
                            ...
                            <li><hr class="dropdown-divider"></li>
                            <li class="dropdown-item text-center">
                                <a href="<?php echo base_url('admin/customer_reminders'); ?>" class="text-decoration-none">
    ...
    <script>
        function updateTimes() {
            try {
                ...
                // Simple timezone offset calculation (more reliable)
                ...
                // Update USA time zones with simple offset calculation
                ...
                if (easternElement) {
                    easternElement.textContent = getTimeInTimezone(now, -5); // EST
                }
                if (centralElement) {
                    centralElement.textContent = getTimeInTimezone(now, -6); // CST
                }
                if (mountainElement) {
                    mountainElement.textContent = getTimeInTimezone(now, -7); // MST
                }
                if (pacificElement) {
                    pacificElement.textContent = getTimeInTimezone(now, -8); // PST
                }
        ...
        // Force update after a short delay to ensure elements are available
        setTimeout(function() {
            updateTimes();
        }, 100);
        
        // Additional fallback - update every 5 seconds as backup
        setInterval(function() {
            const easternElement = document.getElementById('eastern-time');
            if (easternElement && easternElement.textContent === '--:--') {
                updateTimes();
            }
        }, 5000);
        ...
        setInterval(function() {
            fetch('<?php echo base_url('admin/get_notifications'); ?>', {
                method: 'GET',
                headers: {
                    'X-Requested-With': 'XMLHttpRequest'
                }
        ...
        function markReminderComplete(reminderId) {
            fetch('<?php echo base_url('admin/mark_reminder_complete'); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded',
                    'X-Requested-With': 'XMLHttpRequest'
        ...
        setInterval(function() {
            fetch('<?php echo base_url('admin/get_reminders'); ?>', {
                method: 'GET',
                headers: {
                    'X-Requested-With': 'XMLHttpRequest'
                }
