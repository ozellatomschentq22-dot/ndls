...
<div class="d-flex">
    ...
    <div class="main-content">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">
                <i class="fas fa-history me-2"></i>Wallet Transactions
            </h1>
            <div class="btn-toolbar mb-2 mb-md-0">
                <div class="btn-group me-2">
                    <a href="<?php echo base_url('admin/credit_wallet/' . $user->id); ?>" class="btn btn-sm btn-success">
                        <i class="fas fa-plus-circle me-1"></i>Credit Wallet
                    </a>
                    <a href="<?php echo base_url('admin/debit_wallet/' . $user->id); ?>" class="btn btn-sm btn-danger">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 text-end">
                        <div class="mb-2">
                            ...
                            <p class="mb-0 fs-3 <?php echo $wallet->balance < 0 ? 'text-danger' : 'text-primary'; ?>">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="fw-bold <?php echo $transaction->balance_after < 0 ? 'text-danger' : 'text-success'; ?>">
