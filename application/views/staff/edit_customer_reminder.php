    ...
    <div class="main-content">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <div>
                ...
                <p class="text-muted mb-0">Update reminder details for customer</p>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <?php echo form_open('staff/update_customer_reminder/' . $reminder->id); ?>
                            ...
                            <select class="form-select <?php echo form_error('customer_id') ? 'is-invalid' : ''; ?>" 
                                ...
                                <?php foreach ($customers as $customer): ?>
                                    <option value="<?php echo $customer->id; ?>" 
                                            <?php echo (set_value('customer_id', $reminder->customer_id) == $customer->id) ? 'selected' : ''; ?>>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-8">
                            ...
                            <input type="text" class="form-control <?php echo form_error('title') ? 'is-invalid' : ''; ?>" 
                                   id="title" name="title" value="<?php echo set_value('title', $reminder->title); ?>" 
