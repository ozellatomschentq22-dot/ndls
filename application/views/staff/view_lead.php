...
<div class="d-flex">
    ...
    <div class="main-content">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">
                <i class="fas fa-user me-2 text-success"></i>Lead Details
            </h1>
            <div class="btn-toolbar mb-2 mb-md-0">
                <div class="btn-group me-2">
                    <a href="<?php echo base_url('staff/edit_lead/' . $lead->id); ?>" class="btn btn-outline-primary btn-sm">
                        <i class="fas fa-edit me-1"></i>Edit
                    </a>
                    <?php if ($lead->status !== 'converted'): ?>
                        <a href="<?php echo base_url('staff/convert_lead_to_customer/' . $lead->id); ?>" 
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div>
                                <a href="<?php echo base_url('staff/view_customer/' . $lead->converted_to_user_id); ?>" 
